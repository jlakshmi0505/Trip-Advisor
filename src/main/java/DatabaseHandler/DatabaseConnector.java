...
public class DatabaseConnector {
     ...
     * you see the message "Connection to database established" then yourLoginDatabaseHandler.java
        ...
        try {
            ...
            if (test.testConnection()) {
                ...
                if (status == Status.OK) {
                    ...
                    if (!db.checkHotelTableAlreadyPopulated()) {
                        builder.loadHotelInfo(inputHotelFile);
                        System.out.println("Hotel Table Populated");
                    }
                    if (!db.checkReviewTableAlreadyPopulated()) {
